...
\onecolumn
%\titleformat{\subsubsection}[display]{\bfseries}{}{0.5ex}{}[]
\begin{document}
...
\input{sections/02_system} \clearpage
\input{sections/03_framing_overlap_add} \clearpage
\input{sections/04_noise_estimation} \clearpage
\input{sections/05_snr_estimation} \clearpage
\input{sections/06_vad} \clearpage
\input{sections/07_target_estimation} \clearpage
\input{sections/bonus} \clearpage
